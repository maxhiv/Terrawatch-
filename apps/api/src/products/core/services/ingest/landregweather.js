  ...
  try {
    const { data } = await axios.get(OPENMETEO_URL, {
      params: {
        latitude:          lat,
        longitude:         lon,
        hourly:            'temperature_2m,relative_humidity_2m,precipitation,wind_speed_10m,wind_direction_10m,surface_pressure,cape,shortwave_radiation,uv_index,lifted_index,soil_moisture_0_to_7cm,convective_inhibition,boundary_layer_height',
