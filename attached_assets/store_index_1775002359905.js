...
export const useStore = create((set, get) => ({
  ...
  airplusStatus: null,
  goesStatus: null,
  goesLatest: null,   // GOES-19 push DB readings: gradient, bloom_index, qpe_6h, glm_flashes…
  ...
  fetchGoesLatest: async () => {
    try {
      ...
      const data = await res.json()
      set({ goesLatest: data.readings || null })
    } catch (e) { console.error('[Store] goesLatest fetch error:', e) }
  },
