    ...
    <>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        body{background:#eef6f2;font-family:'Inter',sans-serif}
        ::-webkit-scrollbar{width:4px;height:4px}
        ::-webkit-scrollbar-track{background:#e2f0ea}
        ::-webkit-scrollbar-thumb{background:#0a9e80;border-radius:4px}
        ::selection{background:#0a9e8022;color:#0a3d2b}
      ...
      <div style={{minHeight:"100vh",background:C.bg,color:C.text,
        ...
        backgroundImage:`radial-gradient(ellipse 100% 40% at 50% -5%, #001828 0%, transparent 50%)`}}>

        {/* HEADER */}
        <div style={{borderBottom:`1px solid ${C.border}`,background:`rgba(245,251,248,0.95)`,
          backdropFilter:"blur(12px)",boxShadow:"0 1px 0 #cce4d8,0 2px 12px rgba(10,158,128,0.06)",padding:"0 28px",position:"sticky",top:0,zIndex:200}}>
          <div style={{maxWidth:1480,margin:"0 auto",display:"flex",alignItems:"center",gap:18,height:56}}>
            <div>
            ...
            <div style={{display:"flex",gap:0,flex:1,overflowX:"auto"}}>
              {TABS.map((t,i)=>(
                <button key={t} onClick={()=>setTab(i)} style={{
                  ...
                  padding:"0 15px",height:56,fontSize:11,fontWeight:tab===i?700:400,
        ...
        <div style={{maxWidth:1480,margin:"0 auto",padding:"26px 28px 60px"}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"200px 1fr",gap:14,alignItems:"start"}}>
                ...
                {phase&&(
                  <div style={{background:C.panel,border:`1px solid ${phase.color}55`,
                    borderRadius:9,padding:"22px 24px",animation:"in 0.2s ease"}}>
                    <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:18}}>
                      <div style={{width:12,height:12,borderRadius:"50%",background:phase.color,
                        animation:activePhase==="now"?"pulse 2s infinite":"none"}}/>
                      <div>
                            ...
                            <div style={{flex:1}}>
                              ...
                              {isOpen&&(
                                <div style={{fontSize:11,color:C.muted,lineHeight:1.7,
                                  ...
                                  animation:"in 0.15s ease"}}>{item.why}</div>
                              )}
                            </div>
